...
<body>
  ...
  <div class="container-fluid">
        <div class="d-flex align-items-center justify-content-between">
          <h1 class="font-icon"><a href="{{ route('lembar.kerja', $materi->id) }}"><i class="bi bi-arrow-left" style="font-size:30px; color:#fff; top:10px; position:relative;"></i></a></h1>
          </div>
                    ...
                    <div id="collapse{{$data->id}}" class="accordion-collapse collapse {{ $loop->iteration == 1 ? 'show':'' }}" aria-labelledby="heading{{$data->id}}" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        ...
                        <div class="form-group mt-3">
                          ...
                          <textarea class="summernote note"  name="jawaban[]" class="form-control" autofocus></textarea>
