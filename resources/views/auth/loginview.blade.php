            ...
            <div class="col-md-4">
                <div class="card" style="min-height:640px;">
                    <div class="card-body">
                        ...
                        <form action="{{ route('login.post')}}" method="POST" class="text-sm">
                            @csrf
                        ...
                        <div class="mt-4">
                            <button class="w-100 btn btn-md text-white mb-3" type="submit" style="background-color: #F7941D;">Masuk</button>
                        </div>
                        </form>
                        <div class="text-center mt-4">
                            Belum Memiliki Akun? <a href="{{ route('register')}}" class="text-dark"> Daftar</a><br>
