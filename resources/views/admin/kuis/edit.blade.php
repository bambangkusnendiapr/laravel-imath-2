...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          <div class="breadcrumb-item active"><a href="#">Update Kuis</a></div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="{{ route('kuis.update',$kuis->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-10">
                      <select name="materi_id" class="form-control" id="" required>
                            <option value="{{$kuis->materi_id}}" selected>{{$kuis->materi->judul}}</option>
                      </select>
                    </div>
                </div>
                ...
                <div class="plus"></div>
                @foreach ($soals->where('kuis_id',$kuis->id) as $soal)
