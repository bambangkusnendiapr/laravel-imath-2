  ...
  <div class="row justify-content-center">
    <div class="col-md-4">
      ...
      @if (session()->has('error'))    
        ...
        <div class="row">
          <div class="col">
            <h5 class="text-center mb-4" style="color: #ffffff;">{{$materi->judul}}</h5>
              <div class="container isimateri">
              {!!$materi->isi_materi!!}
              </div>
          </div>
        </div>
              ...
              <div class="item-listing">
                ...
                <div class="item-single">
                  <div class="garis-fixed">
                    ...
                    <div class="paragrap">
                      <h5 class="text-center" style="color: brown">Pengetahuan {{ $iterasi }}</h5>
                      <p>{{$data->isi}}</p>
                    </div>
                  </div>
